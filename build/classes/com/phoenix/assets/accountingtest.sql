...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2815185493ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=accountingtest&table=accountdetails">`accountingtest`.`accountdetails`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=accountingtest&table=AccountDetails">`accountingtest`.`AccountDetails`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=accountingtest&table=transactions">`accountingtest`.`transactions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=user">`test`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6c774a41335463632f7b445757572b72">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="accountingtest" targettable="accountdetails">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `accountingtest`.`accountdetails` ( `id` INT NOT NULL ,  `name` VARCHAR(20) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="accountingtest" targettable="accountdetails">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `accountdetails` (`id`, `name`) VALUES (&#039;1&#039;, &#039;cashbook&#039;), (&#039;2&#039;, &#039;bank loan&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="accountingtest" targettable="transactions">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `accountingtest`.`transactions` ( `tID` INT NOT NULL ,  `amount` INT NOT NULL ,  `Debit` VARCHAR(20) NOT NULL ,  `Credit` VARCHAR(20) NOT NULL ,    PRIMARY KEY  (`tID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="accountingtest" targettable="accountdetails">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `accountingtest`.`accountdetails` ( `id` VARCHAR(5) NOT NULL ,  `name` VARCHAR(20) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
